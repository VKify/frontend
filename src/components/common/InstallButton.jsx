      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={`absolute z-50 ${dropUp ? 'bottom-full mb-2' : 'top-full mt-2'} ${block ? 'left-0 right-0' : 'right-0 w-72'} rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-2xl p-2`}
          >
