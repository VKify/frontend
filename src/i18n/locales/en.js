...
export const en = {
  ...
  welcome: {
    ...
    titlePre: 'Welcome to',
    titleAccent: 'VKify!',
    kicker: 'Your extension is ready',
    subtitle: 'Choose a look and enable the tools you need — VKify handles the rest.',
    ...
    downloads: {
      ...
      subtitle: 'Download buttons appear in the matching VKontakte sections.',
      enableAll: 'Enable all',
      items: {
        video_download: { title: 'Videos', desc: 'Choose from available quality levels' },
        audio_download: { title: 'Music', desc: 'Tracks and albums as MP3 or M4A' },
        clip_download:  { title: 'Clips', desc: 'A button beside the clip controls' },
        photo_download: { title: 'Photos', desc: 'Originals and albums as ZIP archives' },
        story_download: { title: 'Stories', desc: 'Photos and videos from the viewer' },
      },
    },
    quickSettings: 'Quick start',
    quickSettingsSubtitle: 'Enable the recommended protection and choose your interface density. Everything else is in the extension menu.',
    settings: {
      ad_protection:      { title: 'A clean, ad-free feed', desc: 'Hides banners and promoted posts with the main filter' },
    ...
    steps: [
      { title: 'Choose your look', desc: 'Apply a theme here or build your own under Appearance' },
      { title: 'Open VKontakte',   desc: 'VKify connects to the page automatically' },
      { title: 'Visit the Center', desc: 'Downloads, player controls, and content tools live there' },
    ],
    openVk: 'Open VK',
  ...
  docsPage: {
    ...
    imageOpen: 'Open larger image',
    imageViewer: 'Image viewer',
    imageClose: 'Close image',
    zoomIn: 'Zoom in',
    zoomOut: 'Zoom out',
    zoomReset: 'Reset zoom',
    zoomHint: 'Mouse wheel or double-click · pinch with two fingers on mobile',
    mediaGif: 'Demo (GIF)',
  ...
  paramMeta: {
    ...
    labels: {
      ...
      border_radius: 'Avatar rounding', avatar_radius_shape: 'Avatar shape',
      content_width_enabled: 'Widen content', content_width: 'Content width',
      ...
      collapse_search: 'Collapse search', hide_stories: 'Stories',
      hide_post_box: 'Post composer', hide_post_comments: 'Comments', hide_recommendations: 'Recommendations',
      hide_friends_suggestions: 'Friend suggestions', hide_emoji_status: 'Emoji statuses', hide_mini_chat: 'Mini chat',
      hide_scroll_top: '“Scroll to top” button', hide_menu_settings: 'Settings in menu', hide_menu_counters: 'Menu counters',
      hide_audio_ads: 'Audio ads', hide_recent_groups: 'Recent groups',
      hide_recommended_channels: 'Recommended channels', hide_auth_popup: 'Auth popup',
    },
  },
