...
export const ru = {
  ...
  paramMeta: {
    ...
    labels: {
      ...
      border_radius: 'Скругление', content_width_enabled: 'Расширить контент', content_width: 'Ширина контента',
      ...
      collapse_search: 'Свернуть поиск', hide_stories: 'Истории', hide_recommendations: 'Рекомендации',
      hide_friends_suggestions: 'Возможные друзья', hide_emoji_status: 'Эмодзи-статусы', hide_mini_chat: 'Мини-чат',
      hide_scroll_top: 'Кнопка «Наверх»', hide_menu_settings: 'Настройки в меню', hide_auth_popup: 'Окно авторизации',
    },
  },
