...
export const ru = {
  ...
  welcome: {
    ...
    titleAccent: 'VKify!',
    kicker: 'Расширение готово к работе',
    subtitle: 'Выберите оформление и включите нужные инструменты — остальное VKify сделает сам.',
    ...
    downloads: {
      ...
      subtitle: 'Кнопки скачивания появятся в соответствующих разделах ВКонтакте.',
      enableAll: 'Включить всё',
      items: {
        video_download: { title: 'Видео', desc: 'Выбор доступного качества' },
        audio_download: { title: 'Музыка', desc: 'Треки и альбомы в MP3 или M4A' },
        clip_download:  { title: 'Клипы', desc: 'Кнопка рядом с управлением клипом' },
        photo_download: { title: 'Фото', desc: 'Оригиналы и альбомы ZIP-архивом' },
        story_download: { title: 'Истории', desc: 'Фото и видео из просмотрщика' },
      },
    },
    quickSettings: 'Быстрый старт',
    quickSettingsSubtitle: 'Включите рекомендуемую защиту и выберите плотность интерфейса. Остальные настройки доступны в меню расширения.',
    settings: {
      ad_protection:      { title: 'Чистая лента без рекламы', desc: 'Скрывает баннеры и рекламные публикации основным фильтром' },
    ...
    howStart: 'Как начать',
    steps: [
      { title: 'Выберите оформление', desc: 'Примените тему здесь или создайте свою в разделе «Оформление»' },
      { title: 'Откройте ВКонтакте',  desc: 'VKify подключится к странице автоматически' },
      { title: 'Загляните в Центр',   desc: 'Там находятся загрузки, плеер и инструменты для контента' },
    ],
    openVk: 'Открыть VK',
  ...
  docsPage: {
    kicker: 'Документация',
    quickTitle: 'Быстрый доступ к любой функции',
    quickPre: 'Внутри расширения нажмите ',
    quickPost: ' и начните вводить название — поиск откроет нужную функцию и подсветит её. Якоря разделов на этой странице совпадают с функциями расширения.',
    onThisPage: 'На странице',
    howItWorks: 'Как работает',
    whatHides: 'Что скрывает',
    soon: 'Позже',
    ...
    imageOpen: 'Открыть изображение крупнее',
    imageViewer: 'Просмотр изображения',
    imageClose: 'Закрыть изображение',
    zoomIn: 'Приблизить',
    zoomOut: 'Отдалить',
    zoomReset: 'Сбросить масштаб',
    zoomHint: 'Колесо или двойной клик · на телефоне — сведите или разведите пальцы',
